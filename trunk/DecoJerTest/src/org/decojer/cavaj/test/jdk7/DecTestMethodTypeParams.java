...
public class DecTestMethodTypeParams<T extends Integer> {
	...
	public void testParametrizedMethods() {
		...
		DecTestMethodTypeParams.<Integer> parameterizedStaticClassMethod(3, 4);
		this.<Integer, Long> parameterizedClassMethod(5, 6L);
		System.out.println(((DecTestMethodTypeParams<Integer>) this)
				.<Long> parameterizedClassMethod2(7, 8L));
		((DecTestMethodTypeParams<Integer>) this).parameterizedClassMethod3(9,
				10);
	}
