...
/**
 * Transformer: Line Number Ordering.
 * 
 * @author André Pankraz
 */
public final class TrLineNumberOrdering {

	private final static Logger LOGGER = Logger.getLogger(TrLineNumberOrdering.class.getName());
